...
<div class="w3-third" >
  ...
  <h3>신제품 기획</h3><br>
  <button class="w3-button w3-border w3-hover-red" style="cursor:pointer" onclick="location.href='pur_writeform.jsp'">등록</button>
  <button class="w3-button w3-border w3-hover-red" style="cursor:pointer" onclick="location.href='pur_list.jsp'">조회</button>
  </div>
</div>
